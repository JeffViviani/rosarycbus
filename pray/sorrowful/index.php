...
<!DOCTYPE html>
	...
	<body>
		...
		<div class='full-page-box'>
			...
			<div id="main-content">
				<a href="../sorrowful/index.php"><div class='bar-1 red-bar'></div></a>
				...
				<center><p class="tiny-text">You are viewing the scriptural rosary. To view the meditative rosary instead, <a href="../variants/meditative/sorrowful/index.php">click here</a>.</center>
